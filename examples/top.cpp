...
#include <examples/problems/top/Reader.hpp>
...
int main(int argc, const char *argv[]) {
    argparse::ArgumentParser parser(argv[0], "TOP Solver (Composable)");
...
#ifdef CPLEX_FOUND
    try {
        auto problem = composable::top::Reader().readFile(inputFile);
