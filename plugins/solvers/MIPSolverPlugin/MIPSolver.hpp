...
public:
     ...
     * @param backendType Backend to use ("cplex", "gurobi", "highs")
     */
    explicit MIPSolver(Problem* problem, const std::string& backendType = "cplex")
        : problem_(problem)
        , solution_(nullptr)
        ...
        , verbose_(false)
    {
        ...
        if (backendType == "cplex" || backendType == "mip") {
