...
if(NOT  CPLEX_ROOT_DIR)
    if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
        set(CPLEX_ROOT_DIR /Applications/CPLEX_Studio221/)
    else ()
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Cplex DEFAULT_MSG
        CPLEX_LIBRARY CPLEX_INCLUDE_DIR CPLEX_ILOCPLEX_LIBRARY CPLEX_CONCERT_LIBRARY CPLEX_CONCERT_INCLUDE_DIR CPLEX_CPOPTIMIZER_LIBRARY CPOPTIMIZER_INCLUDE_DIR)

IF(CPLEX_FOUND)
    SET(CPLEX_INCLUDE_DIRS ${CPLEX_INCLUDE_DIR} ${CPLEX_CONCERT_INCLUDE_DIR} ${CPOPTIMIZER_INCLUDE_DIR})
    ...
    add_compile_definitions(CPLEX_FOUND)
ENDIF(CPLEX_FOUND)

MARK_AS_ADVANCED(CPLEX_LIBRARY CPLEX_INCLUDE_DIR CPLEX_ILOCPLEX_LIBRARY CPLEX_CONCERT_INCLUDE_DIR CPLEX_CONCERT_LIBRARY CPLEX_CPOPTIMIZER_LIBRARY)